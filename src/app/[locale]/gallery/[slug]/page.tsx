...
function ArtworkDetailContent({ artwork, translation, artistName, locale, prefix, artworkUrl, whatsappNumber }: any) {
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          {artwork.price && (
            <p className="text-2xl font-serif text-terracotta mb-4">{formatPrice(artwork.price, locale)}</p>
          )}
          {artwork.medium && (
